CREATE   PROCEDURE [dbo].[k_GetSumDolgPenySup]
(
	  @occ1 INT
...
BEGIN
	...
	*/
	...
	IF @debug = 1
	BEGIN
		PRINT 'Фин_период=' + dbo.Fun_NameFinPeriod(@fin_id)
		PRINT '@saldo=' + STR(@saldo, 15, 4)
		PRINT '@Res2=' + STR(@res2, 15, 4)
		PRINT '@sum_pay=' + STR(@sum_pay, 15, 4)
		PRINT '@day=' + STR(@day)
		PRINT 'Результат=' + STR(@Res, 15, 4)
	END
END
go
