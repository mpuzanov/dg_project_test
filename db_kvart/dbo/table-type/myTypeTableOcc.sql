create type myTypeTableOcc as table
(
    occ            int not null,
    ...
    summa2         decimal(9, 2),
    summa3         decimal(9, 2),
    PROPTYPE_ID    varchar(10) collate SQL_Latin1_General_CP1251_CI_AS,
    ROOMTYPE_ID    varchar(10) collate SQL_Latin1_General_CP1251_CI_AS,
