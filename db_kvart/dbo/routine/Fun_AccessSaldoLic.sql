CREATE   FUNCTION [dbo].[Fun_AccessSaldoLic]
(
	@occ1 INT
)
RETURNS TINYINT
...
BEGIN
	--
	-- Проверка доступа к заданному лицевому для работы с Сальдо
	--
	...
	IF dbo.Fun_GetOccClose(@occ1) = 0
		RETURN @result1; -- лицевой счет закрыт
