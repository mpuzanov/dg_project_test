CREATE   FUNCTION [dbo].[Fun_DolgMesCalAll_date]
(
	@occ		INT
	,@fin_id1	SMALLINT
	,@fin_id2	SMALLINT
...
SELECT [dbo].[Fun_DolgMesCalAll_date] (66525,90,100) 
SELECT [dbo].[Fun_DolgMesCalAll_date] (700300092,153,156) 
*/
...
BEGIN
	...
	BEGIN
		...
		(	fin_id
			...
			SELECT
				@fin_Current
				,COALESCE(o.PaidAll, 0) - COALESCE(o.Paymaccount_ServAll, 0)
