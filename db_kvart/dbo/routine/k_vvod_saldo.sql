CREATE   PROCEDURE [dbo].[k_vvod_saldo]
(
	@occ1			INT
	,@saldo_str1	VARCHAR(4000) -- строка формата: код услуги:новое значение сальдо;код услуги:новое значение сальдо
)
AS
/*
...
дата последней модификации:  8.10.04
...
BEGIN TRY
	...
	INTO @t1
		SELECT
			id
			,val
		FROM dbo.Fun_split_IdValue(@saldo_str1, ';')
